...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { denomination: @coin.denomination, fk_user_id: @coin.fk_user_id } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { denomination: @coin.denomination, fk_user_id: @coin.fk_user_id } }
